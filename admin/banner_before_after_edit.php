...
<head>
	...
	<title>Banner Before After Edit | Doctor T </title>
...
<body class="animsition dashboard">
	...
	if(empty($_GET['id']))
	{
		header('location: banner_before_after.php');
		exit;
	}
	
	$banner_before_detail = banner_before_detail($_GET['id']);
					...
					<!-- Panel Static Labels -->
		          	<div class="panel">
			            <div class="panel-heading">
			              <h3 class="panel-title">Banner Before After Edit</h3>
			            </div>
			            <div class="panel-body container-fluid">
			              	<form id="productEdit" name="productEdit" class="form-horizontal" method="post" enctype="multipart/form-data">
				                <div class="form-group form-material" data-plugin="formMaterial">
				                  	...
				                  	<input type="text" class="form-control" id="name" name="name" placeholder="" value="<?php echo $banner_before_detail->name; ?>" required>
				                </div>
								<!-- <div class="form-group form-material" data-plugin="formMaterial">
									...
									<textarea class="form-control summernote" rows="4" id="description" name="description">
										<?php echo $banner_before_detail->desc; ?>
									</textarea>
								</div> -->
								<!-- <div class="form-group form-material" data-plugin="formMaterial">
				                  	<label class="form-control-label" for="link_pdf">Link Youtube</label>
				                  	<input type="text" class="form-control" id="link_pdf" name="link_pdf" value="<?php echo $banner_before_detail->link; ?>">
				                </div> -->
								<div class="form-group form-material form-material-file" data-plugin="formMaterial">
			                      	...
			                      	<input type="file" id="covImg" name="covImg" data-plugin="dropify" data-default-file="<?php echo '../images/banner_beforafter/' . $banner_before_detail->id . '/' . $banner_before_detail->img_cover; ?>" data-allowed-file-extensions="png jpg"/>
									<p class="help-block"><i>Image size: 1400x600px</i></p>
				                </div>
				                <div class="text-right">
				                	<input type="hidden" name="product_id" value="<?php echo $banner_before_detail->id; ?>">
						            ...
						            <button type="button" class="btn btn-animate btn-animate-side btn-default btn-outline" onclick="window.location.href = 'banner_before_after.php';">
