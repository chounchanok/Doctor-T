			                  						...
			                  						<tr> 
			                  							...
			                  							<td style="">
			                  								<?php if ($product_detail->is_selected== '1') : ?>
			                  									<button class="btn btn-sm btn-success btn-icon btn-floating" type="button" onclick="baChange(<?php echo $product_detail->id; ?>, 0)"><i class="icon wb-check" aria-hidden="true"></i></button>
			                  								<?php else : ?>
