...
<head>
	...
	<title>Before After Add | Doctor T </title>
					...
					<!-- Panel Static Labels -->
		          	<div class="panel">
			            <div class="panel-heading">
			              <h3 class="panel-title">Before After Add</h3>
			            </div>
			            <div class="panel-body container-fluid">
			              	<form id="productAdd" name="productAdd" class="form-horizontal" method="post" enctype="multipart/form-data">
								...
								<div class="form-group form-material" data-plugin="formMaterial">
				                  	<label class="form-control-label" for="link_pdf">Link yotube</label>
