...
<head>
	...
	<title>Celebrities Add | Doctor T </title>
					...
					<!-- Panel Static Labels -->
		          	<div class="panel">
			            <div class="panel-heading">
			              <h3 class="panel-title">Celebrities Add</h3>
			            </div>
			            ...
			            <div class="panel-body container-fluid">
			              	<form id="productAdd" name="productAdd" class="form-horizontal" method="post" enctype="multipart/form-data">
								...
								<div class="form-group form-material" data-plugin="formMaterial">
									...
									<textarea class="form-control summernote" rows="4" placeholder="Detail" id="description" name="notes"></textarea>
								</div>
								<div class="form-group form-material" data-plugin="formMaterial">
