...
<body class="animsition dashboard">
	...
	{	
		...
		// exit;
		if(celeb_edit_detail())
		{
			echo '<script>
			     alert("แก้ไขข้อมูลสำเร็จ");
			     window.location.href = "celeb.php"
			      </script>';
			exit;
		}
	}
	...
	if(empty($_GET['id']))
	{
		header('location: celeb.php');
		exit;
	}
	
	$celeb_edit = celeb_edit($_GET['id']);
			            ...
			            <div class="panel-body container-fluid">
			              	<form id="serviceAdd" name="serviceAdd" class="form-horizontal" method="post" enctype="multipart/form-data">
				                <div class="form-group form-material" data-plugin="formMaterial">
				                  	...
				                  	<input type="text" class="form-control" id="name" name="name" value="<?php echo $celeb_edit->name; ?>" required>
				                </div>
								...
								<div class="form-group form-material" data-plugin="formMaterial">
				                  	...
				                  	<input type="text" class="form-control" id="link" name="link" value="<?php echo $celeb_edit->link; ?>">
				                </div>

								<div class="form-group form-material form-material-file" data-plugin="formMaterial">
				                  	<label class="form-control-label" for="image">Image</label>
			                      	<input type="file" id="covImg" name="covImg" data-plugin="dropify" data-default-file="<?php echo '../images/celebss/' . $celeb_edit->id . '/' . $celeb_edit->img_cover; ?>" data-allowed-file-extensions="png jpg"/>
									<p class="help-block"><i>Image size: 1400x600px</i></p>
				                </div>
				                <div class="text-right">
				                	<input type="hidden" name="celeb_edit" value="<?php echo $celeb_edit->id; ?>">
						            ...
						            <button type="button" class="btn btn-animate btn-animate-side btn-default btn-outline" onclick="window.location.href = 'celeb.php';">
