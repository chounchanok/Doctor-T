...
function product_add() {
	...
	$sql	 = "INSERT INTO tbl_reviews
				...
				'{$_POST['name2']}', '{$_POST['description2']}', '{$_POST['link_pdf2']}', 
				-- '{$_POST['name3']}', '{$_POST['description3']}', '{$_POST['link_pdf3']}', 
				-- '{$_POST['name4']}', '{$_POST['description4']}', '{$_POST['link_pdf4']}', 
				-- '{$_POST['name5']}', '{$_POST['description5']}', '{$_POST['link_pdf5']}', 
				-- '{$_POST['name6']}', '{$_POST['description6']}', '{$_POST['link_pdf6']}', 
				-- '{$_POST['name7']}', '{$_POST['description7']}', '{$_POST['link_pdf7']}', 
				-- '{$_POST['name8']}', '{$_POST['description8']}', '{$_POST['link_pdf8']}', 
				-- '{$_POST['name9']}', '{$_POST['description9']}', '{$_POST['link_pdf9']}', 
				-- '{$_POST['name10']}', '{$_POST['description10']}', '{$_POST['link_pdf10']}', 
				'{$created}')";
	// exit;
	$added = query($sql);
	...
	if(!empty($added))
	{
		...
		if(!empty($_FILES['covImg']))
		{
			...
			if($moved)
			{
				...
				$sql = "UPDATE tbl_reviews SET img_cover1 = '{$file_name}' WHERE id = '{$product_id}'";
				query($sql);
			}
		}
		...
		if(!empty($_FILES['covImg2']))
		{
			...
			if($moved)
			{
				...
				$sql = "UPDATE tbl_reviews SET img_cover2 = '{$file_name}' WHERE id = '{$product_id}'";
				query($sql);
			}
		}
		...
		// 		$sql = "UPDATE tbl_reviews SET img_cover3 = '{$file_name}' WHERE id = '{$product_id}'";
		// 		query($sql);
		// 	}
		// }
		...
		// 		$sql = "UPDATE tbl_reviews SET img_cover4 = '{$file_name}' WHERE id = '{$product_id}'";
		// 		query($sql);
		// 	}
		// }
		...
		// 		$sql = "UPDATE tbl_reviews SET img_cover5 = '{$file_name}' WHERE id = '{$product_id}'";
		// 		query($sql);
		// 	}
		// }
		...
		// 		$sql = "UPDATE tbl_reviews SET img_cover6 = '{$file_name}' WHERE id = '{$product_id}'";
		// 		query($sql);
		// 	}
		// }
		...
		// 		$sql = "UPDATE tbl_reviews SET img_cover7 = '{$file_name}' WHERE id = '{$product_id}'";
		// 		query($sql);
		// 	}
		// }
		...
		// 		$sql = "UPDATE tbl_reviews SET img_cover8 = '{$file_name}' WHERE id = '{$product_id}'";
		// 		query($sql);
		// 	}
		// }
		...
		// 		$sql = "UPDATE tbl_reviews SET img_cover9 = '{$file_name}' WHERE id = '{$product_id}'";
		// 		query($sql);
		// 	}
		// }
		...
		// 		$sql = "UPDATE tbl_reviews SET img_cover10 = '{$file_name}' WHERE id = '{$product_id}'";
		// 		query($sql);
		// 	}
		// }
