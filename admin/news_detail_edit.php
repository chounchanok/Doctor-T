...
<body class="animsition dashboard">
	...
	{	
		...
		if(news_detail_edit())
		{
			echo '<script>
			     ...
			     window.location.href = "news_detail.php"
			      </script>';
			exit;
		}
	}
	...
	if(empty($_GET['id']))
	{
		header('location: news_detail.php');
		exit;
	}
	
	$news_detail = news_detail($_GET['id']);
			            ...
			            <div class="panel-body container-fluid">
			              	<form id="serviceAdd" name="serviceAdd" class="form-horizontal" method="post" enctype="multipart/form-data">
				                <div class="form-group form-material" data-plugin="formMaterial">
				                  	...
				                  	<input type="text" class="form-control" id="name" name="name" value="<?php echo $news_detail->name; ?>" required>
				                </div>
								...
								<div class="form-group form-material form-material-file" data-plugin="formMaterial">
			                      	...
			                      	<input type="file" id="covImg" name="covImg" data-plugin="dropify" data-default-file="<?php echo '../images/news_detail/' . $news_detail->id . '/' . $news_detail->img_cover; ?>" data-allowed-file-extensions="png jpg"/>
									<p class="help-block"><i>Image size: 1400x600px</i></p>
				                </div>
				                <div class="text-right">
				                	<input type="hidden" name="new_id" value="<?php echo $news_detail->id; ?>">
