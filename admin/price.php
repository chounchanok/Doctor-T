...
<body class="animsition dashboard">
	...
	<?php $price_allse_list = price_all_list(); ?>
			                  		...
			                  		<div class="" style="padding-bottom: 0px;">
			                  			<div class="fixed-table-body">
			                  				...
			                  				<!-- <table id="exampleTablePagination" data-toggle="table" data-url="../assets/data/bootstrap_table_test.json" data-query-params="queryParams" data-mobile-responsive="true" data-height="400" data-pagination="true" data-icon-size="outline" data-search="true" class="table table-hover" style="margin-top: -36px;"> -->
			                    				<thead style="">
			                    					<tr>
			                    						...
			                    						<th style="" data-field="name" data-align="center">
			                    							<div class="th-inner ">หมวด</div>
			                    							<div class="fht-cell"></div>
			                    						</th>
			                    						<th style="" data-field="a" data-align="center">
			                    							<div class="th-inner ">รายการรักษา</div>
			                    							<div class="fht-cell"></div>
			                    						</th>
                                                        <th style="" data-field="b" data-align="center">
			                    							<div class="th-inner ">ราคา</div>
			                    							<div class="fht-cell"></div>
			                    						</th>
                                                        <th style="" data-field="c" data-align="center">
			                    							<div class="th-inner ">หมายเหตุ</div>
			                    							<div class="fht-cell"></div>
			                    						</th>
														<th style="" data-field="update">
			                    							<div class="th-inner ">Update</div>
			                    							<div class="fht-cell"></div>
			                    						</th>                                                         
			                    				...
			                    				<?php if(!empty($price_allse_list)) : ?>
			                  					<tbody>
			                  						<?php 
													$i = 0;
													foreach($price_allse_list as $price_allse_detail) : 
													?>
			                  						<tr> 
			                  							<td class=""><?php echo $i+1; ?></td> 
			                  							<td style=""><?php echo $price_allse_detail->name_group; ?></td>
                                                        <td style=""><?php echo $price_allse_detail->dsc; ?></td>
                                                        <td style=""><?php echo $price_allse_detail->price; ?></td>
                                                        <td style=""><?php echo $price_allse_detail->remark; ?></td>
														<td style=""><?php echo date("d/m/Y", strtotime( $price_allse_detail->update_date ) ); ?></td>
			                  							<td>
			                  								<button type="button" class="btn btn-round btn-warning btn-sm" onclick="window.location.href = 'price_edit.php?id=<?php echo $price_allse_detail->id; ?>';"><i class="icon wb-pencil" aria-hidden="true"></i></button>
			                  								<!-- <button type="button" class="btn btn-round btn-danger btn-sm" onclick="delP(<?php echo $price_allse_detail->id; ?>)"><i class="icon wb-close" aria-hidden="true"></i></button> -->
			                  							</td> 
			                  						</tr>
			                  						<?php
			                  							$i++;
