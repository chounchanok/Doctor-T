...
<head>
	...
	<title>Product Edit | General S </title>
			            ...
			            <div class="panel-body container-fluid">
			              	<form id="productEdit" name="productEdit" class="form-horizontal" method="post" enctype="multipart/form-data">
								...
								<div class="form-group form-material form-material-file" data-plugin="formMaterial">
			                      	...
			                      	<input type="file" id="covImg" name="covImg" data-plugin="dropify" data-default-file="<?php echo '../assets/images/product/cover/' . $product_detail->id . '/' . $product_detail->img_cover1; ?>" data-allowed-file-extensions="png jpg"/>
								...
								<div class="form-group form-material form-material-file" data-plugin="formMaterial">
				                  	<label class="form-control-label" for="image">Images Cover</label>
			                      	<input type="file" id="covImg2" name="covImg2" data-plugin="dropify" data-default-file="<?php echo '../assets/images/product/cover/' . $product_detail->id . '/' . $product_detail->img_cover2; ?>" data-allowed-file-extensions="png jpg"/>
									<p class="help-block"><i>Image size: 1400x600px</i></p>
				                </div>
								...
								<div class="form-group form-material form-material-file" data-plugin="formMaterial">
				                  	<label class="form-control-label" for="image">Images Cover</label>
			                      	<input type="file" id="covImg3" name="covImg3" data-plugin="dropify" data-default-file="<?php echo '../assets/images/product/cover/' . $product_detail->id . '/' . $product_detail->img_cover3; ?>" data-allowed-file-extensions="png jpg"/>
									<p class="help-block"><i>Image size: 1400x600px</i></p>
				                </div>
								...
								<div class="form-group form-material form-material-file" data-plugin="formMaterial">
				                  	<label class="form-control-label" for="image">Images Cover</label>
			                      	<input type="file" id="covImg4" name="covImg4" data-plugin="dropify" data-default-file="<?php echo '../assets/images/product/cover/' . $product_detail->id . '/' . $product_detail->img_cover4; ?>" data-allowed-file-extensions="png jpg"/>
									<p class="help-block"><i>Image size: 1400x600px</i></p>
				                </div>
								...
								<div class="form-group form-material form-material-file" data-plugin="formMaterial">
				                  	<label class="form-control-label" for="image">Images Cover</label>
			                      	<input type="file" id="covImg5" name="covImg5" data-plugin="dropify" data-default-file="<?php echo '../assets/images/product/cover/' . $product_detail->id . '/' . $product_detail->img_cover5; ?>" data-allowed-file-extensions="png jpg"/>
									<p class="help-block"><i>Image size: 1400x600px</i></p>
				                </div>
								...
								<div class="form-group form-material form-material-file" data-plugin="formMaterial">
				                  	<label class="form-control-label" for="image">Images Cover</label>
			                      	<input type="file" id="covImg6" name="covImg6" data-plugin="dropify" data-default-file="<?php echo '../assets/images/product/cover/' . $product_detail->id . '/' . $product_detail->img_cover6; ?>" data-allowed-file-extensions="png jpg"/>
									<p class="help-block"><i>Image size: 1400x600px</i></p>
				                </div>
								...
								<div class="form-group form-material form-material-file" data-plugin="formMaterial">
				                  	<label class="form-control-label" for="image">Images Cover</label>
			                      	<input type="file" id="covImg7" name="covImg7" data-plugin="dropify" data-default-file="<?php echo '../assets/images/product/cover/' . $product_detail->id . '/' . $product_detail->img_cover7; ?>" data-allowed-file-extensions="png jpg"/>
									<p class="help-block"><i>Image size: 1400x600px</i></p>
				                </div>
								...
								<div class="form-group form-material form-material-file" data-plugin="formMaterial">
				                  	<label class="form-control-label" for="image">Images Cover</label>
			                      	<input type="file" id="covImg8" name="covImg8" data-plugin="dropify" data-default-file="<?php echo '../assets/images/product/cover/' . $product_detail->id . '/' . $product_detail->img_cover8; ?>" data-allowed-file-extensions="png jpg"/>
									<p class="help-block"><i>Image size: 1400x600px</i></p>
				                </div>
								...
								<div class="form-group form-material form-material-file" data-plugin="formMaterial">
				                  	<label class="form-control-label" for="image">Images Cover</label>
			                      	<input type="file" id="covImg9" name="covImg9" data-plugin="dropify" data-default-file="<?php echo '../assets/images/product/cover/' . $product_detail->id . '/' . $product_detail->img_cover9; ?>" data-allowed-file-extensions="png jpg"/>
									<p class="help-block"><i>Image size: 1400x600px</i></p>
				                </div>
								...
								<div class="form-group form-material form-material-file" data-plugin="formMaterial">
				                  	<label class="form-control-label" for="image">Images Cover</label>
			                      	<input type="file" id="covImg10" name="covImg10" data-plugin="dropify" data-default-file="<?php echo '../assets/images/product/cover/' . $product_detail->id . '/' . $product_detail->img_cover10; ?>" data-allowed-file-extensions="png jpg"/>
									<p class="help-block"><i>Image size: 1400x600px</i></p>
				                </div>
