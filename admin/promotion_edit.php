...
<body class="animsition dashboard">
	...
	$promotion_edit = promotion_edit($_GET['id']);
			            ...
			            <div class="panel-body container-fluid">
			              	<form id="serviceAdd" name="serviceAdd" class="form-horizontal" method="post" enctype="multipart/form-data">
				                <div class="form-group form-material" data-plugin="formMaterial">
				                  	<label class="form-control-label" for="title">Titles</label>
				                  	<input type="text" class="form-control" id="name" name="name" value="<?php echo $promotion_edit->title; ?>" required>
				                </div>
				                
								
								<div class="form-group form-material form-material-file" data-plugin="formMaterial">
				                  	<label class="form-control-label" for="image">Image</label>
			                      	<input type="file" id="covImg" name="covImg" data-plugin="dropify" data-default-file="<?php echo '../images/promotions/' . $promotion_edit->id . '/' . $promotion_edit->img_cover; ?>" data-allowed-file-extensions="png jpg"/>
									<p class="help-block"><i>Image size: 1400x600px</i></p>
				                </div>
				                <div class="text-right">
				                	<input type="hidden" name="promotion_id" value="<?php echo $promotion_edit->id; ?>">
						            ...
						            <button type="button" class="btn btn-animate btn-animate-side btn-default btn-outline" onclick="window.location.href = 'promotion.php';">
