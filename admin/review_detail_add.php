...
<head>
	...
	<title>Reviews_Detail Add | Doctor T </title>
					...
					<!-- Panel Static Labels -->
		          	<div class="panel">
			            <div class="panel-heading">
			              <h3 class="panel-title">Reviews_Detail Add</h3>
			            </div>
			            ...
			            <div class="panel-body container-fluid">
			              	<form id="productAdd" name="productAdd" class="form-horizontal" method="post" enctype="multipart/form-data">
				                <div class="form-group form-material" data-plugin="formMaterial">
				                  	...
				                  	<input type="text" class="form-control" id="name" name="name" placeholder="review_detail" required>
				                </div>
								<div class="form-group form-material" data-plugin="formMaterial">
