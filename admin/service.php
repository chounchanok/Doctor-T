			                  			...
			                  			<div class="bs-bars pull-left">
			                  				<div class="btn-group hidden-sm-down" id="exampleToolbar" role="group">
							                    <button type="button" class="btn btn-success btn-outline btn-sm" onclick="window.location.href = 'service_add.php';">
							                      	<i class="icon wb-plus" aria-hidden="true"></i> Add Service
							                    </button>
			                  				</div>
			                  			</div>
			                  		</div>
			                    				...
			                    				<thead style="">
			                    					<tr>
			                    						...
			                    						<th style="" data-field="code">
			                    							<div class="th-inner ">Short Description</div>
			                    							<div class="fht-cell"></div>
			                    						</th>
			                    						<th style="" data-field="">
			                  					...
			                  					<tbody>
													...
													?>
			                  						<tr> 
			                  							...
			                  							<td style=""><?php echo $service_detail->name; ?></td>
			                  							<td style=""><?php echo $service_detail->short_desc; ?></td>
			                  							<td style=""><?php echo date("d/m/Y H:i:s", strtotime( $service_detail->create_date ) ); ?></td>
			                  							<td>
