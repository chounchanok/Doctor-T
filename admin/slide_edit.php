...
<head>
	...
	<title>Slide Edit | General S </title>
...
<body class="animsition dashboard">
	...
	$slide_detail = slide_detail($_GET['id']);
					...
					<!-- Panel Static Labels -->
		          	<div class="panel">
			            <div class="panel-heading">
			              <h3 class="panel-title">Slide Edit</h3>
			            </div>
			            <div class="panel-body container-fluid">
			              	<form id="productEdit" name="productEdit" class="form-horizontal" method="post" enctype="multipart/form-data">
				                <div class="form-group form-material" data-plugin="formMaterial">
				                  	...
				                  	<input type="text" class="form-control" id="sname" name="sname" placeholder="" value="<?php echo $slide_detail->name; ?>" required>
				                </div>
								<div class="form-group form-material form-material-file" data-plugin="formMaterial">
			                      	...
			                      	<input type="file" id="covImg" name="covImg" data-plugin="dropify" data-default-file="<?php echo '../assets/images/slide/' . $slide_detail->id . '/' . $slide_detail->img_cover; ?>" data-allowed-file-extensions="png jpg"/>
									<p class="help-block"><i>Image size: 1400x600px</i></p>
				                </div>
				                <div class="text-right">
				                	<input type="hidden" name="slide_id" value="<?php echo $slide_detail->id; ?>">
